...
public class NeuralModel {
  ...
  /**
   * Prepare image to be putted inside neural network. It will change resolution and format of given
   * image to resolution needed by neural network.
   *
   ...
   * @return MatOfRect matrix of all face rectangular. Face rectangular is beginning point and Size.
   */
  ...
  private Mat rotateImageByEye(Mat image, Rect[] eyeArray) {
    ...
    double delta_y = (eyeArray[0].y + eyeArray[0].height) - (eyeArray[1].y + eyeArray[1].height);
