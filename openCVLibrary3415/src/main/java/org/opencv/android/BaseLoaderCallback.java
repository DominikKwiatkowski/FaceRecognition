    ...
    public void onManagerConnected(int status) {
        switch (status) {
            ...
            case LoaderCallbackInterface.SUCCESS:
                {
                    /**
                     * Application must override this method to handle successful library
                     * initialization. *
                     */
                }
                break;
            ...
            case LoaderCallbackInterface.INSTALL_CANCELED:
                ...
                break;
                /**
                 * Application is incompatible with this version of OpenCV Manager. Possibly, a
                 * service update is required. *
                 */
            case LoaderCallbackInterface.INCOMPATIBLE_MANAGER_VERSION:
                {
                    Log.d(TAG, "OpenCV Manager Service is uncompatible with this app!");
                    AlertDialog IncomatibilityMessage =
                            new AlertDialog.Builder(mAppContext).create();
