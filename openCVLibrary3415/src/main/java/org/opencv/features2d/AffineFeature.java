...
public class AffineFeature extends Feature2D {
    ...
    //
    // C++: static Ptr_AffineFeature cv::AffineFeature::create(Ptr_Feature2D backend, int maxTilt =
    // 5, int minTilt = 0, float tiltStep = 1.4142135623730951f, float rotateStepBase = 72)
    //

    /**
     * @param backend The detector/extractor you want to use as backend.
     * @param maxTilt The highest power index of tilt factor. 5 is used in the paper as tilt
     *     sampling range n.
    ...
    public static AffineFeature create(
            Feature2D backend, int maxTilt, int minTilt, float tiltStep, float rotateStepBase) {
        return AffineFeature.__fromPtr__(
                create_0(backend.getNativeObjAddr(), maxTilt, minTilt, tiltStep, rotateStepBase));
    }
     ...
     */
    public static AffineFeature create(
            Feature2D backend, int maxTilt, int minTilt, float tiltStep) {
        return AffineFeature.__fromPtr__(
                create_1(backend.getNativeObjAddr(), maxTilt, minTilt, tiltStep));
    }
    ...
    private static native long create_0(
            long backend_nativeObj, int maxTilt, int minTilt, float tiltStep, float rotateStepBase);

    private static native long create_1(
            long backend_nativeObj, int maxTilt, int minTilt, float tiltStep);
    ...
    // C++:  void cv::AffineFeature::setViewParams(vector_float tilts, vector_float rolls)
    private static native void setViewParams_0(
            long nativeObj, long tilts_mat_nativeObj, long rolls_mat_nativeObj);

    // C++:  void cv::AffineFeature::getViewParams(vector_float tilts, vector_float rolls)
    private static native void getViewParams_0(
            long nativeObj, long tilts_mat_nativeObj, long rolls_mat_nativeObj);
