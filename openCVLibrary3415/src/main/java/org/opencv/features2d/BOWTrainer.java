...
public class BOWTrainer {
     ...
     *
     * @param descriptors Descriptors to add to a training set. Each row of the descriptors matrix
     *     is a descriptor.
     ...
     *
     * @param descriptors Descriptors to cluster. Each row of the descriptors matrix is a
     *     descriptor. Descriptors are not added to the inner train descriptor set.
