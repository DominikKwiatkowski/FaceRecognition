...
public class Feature2D extends Algorithm {
     ...
     *
     * @param image Image.
     * @param keypoints The detected keypoints. In the second variant of the method keypoints[i] is
     *     a set of keypoints detected in images[i] .
     * @param mask Mask specifying where to look for keypoints (optional). It must be a 8-bit
     *     integer matrix with non-zero values in the region of interest.
     */
     ...
     * @param image Image.
     * @param keypoints The detected keypoints. In the second variant of the method keypoints[i] is
     *     a set of keypoints detected in images[i] . matrix with non-zero values in the region of
     *     interest.
     */
     ...
     * @param images Image set.
     * @param keypoints The detected keypoints. In the second variant of the method keypoints[i] is
     *     a set of keypoints detected in images[i] . masks[i] is a mask for images[i].
     */
     ...
     *     are descriptors computed for a keypoints[i]. Row j is the keypoints (or keypoints[i]) is
