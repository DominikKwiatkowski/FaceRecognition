...
public class GFTTDetector extends Feature2D {
    ...
    // qualityLevel = 0.01, double minDistance = 1, int blockSize = 3, bool useHarrisDetector =
    // false, double k = 0.04)
    //
    ...
    public static GFTTDetector create(
        ...
        return GFTTDetector.__fromPtr__(
                create_0(maxCorners, qualityLevel, minDistance, blockSize, useHarrisDetector, k));
    }
    ...
    public static GFTTDetector create(
            ...
            boolean useHarrisDetector) {
        return GFTTDetector.__fromPtr__(
                create_1(maxCorners, qualityLevel, minDistance, blockSize, useHarrisDetector));
    }
    ...
    public static GFTTDetector create(
            ...
            int gradiantSize) {
        return GFTTDetector.__fromPtr__(
                create_9(maxCorners, qualityLevel, minDistance, blockSize, gradiantSize));
    }
