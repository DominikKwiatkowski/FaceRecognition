 ...
 *       slower than grey image method ( 3~4 times )
 * </ul>
 *
 * <ul>
...
public class MSER extends Feature2D {
    ...
    //
    // C++: static Ptr_MSER cv::MSER::create(int delta = 5, int min_area = 60, int max_area = 14400,
    // double max_variation = 0.25, double min_diversity = .2, int max_evolution = 200, double
    // area_threshold = 1.01, double min_margin = 0.003, int edge_blur_size = 5)
    //
     ...
     * @param min_diversity for color image, trace back to cut off mser with diversity less than
     *     min_diversity
    ...
    public static MSER create(
            ...
            int max_evolution) {
        return MSER.__fromPtr__(
                create_3(delta, min_area, max_area, max_variation, min_diversity, max_evolution));
    }
     ...
     */
    public static MSER create(
            int delta, int min_area, int max_area, double max_variation, double min_diversity) {
    ...
    //
    // C++:  void cv::MSER::detectRegions(Mat image, vector_vector_Point& msers, vector_Rect&
    // bboxes)
    //
    ...
    private static native long create_5(
            int delta, int min_area, int max_area, double max_variation);
