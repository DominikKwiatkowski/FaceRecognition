...
public class Imgcodecs {
   ...
   *   <li>Multiple images (vector of Mat) can be saved in TIFF format (see the code sample below).
   * </ul>
   *
   * If the image format is not supported, the image will be converted to 8-bit unsigned (CV_8U) and
   * saved that way.
   *
