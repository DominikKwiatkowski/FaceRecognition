...
public class Subdiv2D {
     ...
     *     <p><b>Note:</b> If the point is outside of the triangulation specified rect a runtime
     *     error is raised.
     */
     ...
     *     <p>The function inserts a vector of points into a subdivision and modifies the
     ...
     *     <p>The function is another function that locates the input point within the subdivision.
     *     It finds the subdivision vertex that is the closest to the input point. It is not
     *     necessarily one of vertices of the facet containing the input point, though the facet
     *     (located using locate() ) is used as a starting point.
     * @return vertex ID.
     */
    ...
    //
    // C++:  void cv::Subdiv2D::getVoronoiFacetList(vector_int idx, vector_vector_Point2f&
    // facetList,
     ...
     *     values are possible:
     *     <ul>
     *       <li>NEXT_AROUND_ORG next around the edge origin ( eOnext on the picture below if e is
     *           the input edge)
     ...
     *
     * @param edge Subdivision edge ID.
     * @return an integer which is next edge ID around the edge origin: eOnext on the picture above
     ...
     *
     * @param edge Subdivision edge ID.
     * @param rotate Parameter specifying which of the edges of the same quad-edge as the input one
     *     to return. The following values are possible:
     *     <ul>
