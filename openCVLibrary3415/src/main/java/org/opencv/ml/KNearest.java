...
public class KNearest extends StatModel {
     ...
     *
     * @param samples Input samples stored by rows. It is a single-precision floating-point matrix
     *     of {@code &lt;number_of_samples&gt; * k} size.
     * @param k Number of used nearest neighbors. Should be greater than 1.
     * @param results Vector with results of prediction (regression or classification) for each
     *     input sample. It is a single-precision floating-point vector with {@code
     *     &lt;number_of_samples&gt;} elements.
     * @param neighborResponses Optional output values for corresponding neighbors. It is a single-
     *     precision floating-point matrix of {@code &lt;number_of_samples&gt; * k} size.
     * @param dist Optional output distances from the input vectors to the corresponding neighbors.
     *     It is a single-precision floating-point matrix of {@code &lt;number_of_samples&gt; * k}
     *     size.
     ...
     *     vector's neighbor responses. In case of classification, the class is determined by
     *     voting.
     *     <p>For each input vector, the neighbors are sorted by their distances to the vector.
     *     <p>In case of C++ interface you can use output pointers to empty matrices and the
     ...
     *     &lt;number_of_samples&gt; * k} size. is a single-precision floating-point matrix of
