...
public class NormalBayesClassifier extends StatModel {
     ...
     * more) are stored as rows of the matrix inputs. In case of multiple input vectors, there
     * should be one output vector outputs. The predicted class for a single input vector is
     * returned by the method. The vector outputProbs contains the output probabilities
     * corresponding to each element of result.
     *
     ...
     * Load the NormalBayesClassifier from this file again, by calling this function with the path
     * to the file. Optionally specify the node for the file containing the classifier
     *
