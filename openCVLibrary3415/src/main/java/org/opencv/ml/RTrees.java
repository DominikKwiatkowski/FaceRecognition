...
public class RTrees extends DTrees {
     ...
     * computed at the training stage when CalculateVarImportance is set to true. If this flag was
     * set to false, the empty matrix is returned.
     *
     * @return automatically generated
     */
     ...
     * problem, the method will return each of the trees' results for each of the sample cases. If
     * the model is a classifier, it will return a Mat with samples + 1 rows, where the first row
     * gives the class number and the following rows return the votes each class had for each
     * sample.
     *
     ...
     * If this flag was set to false, 0 is returned. The OOB error is also scaled by sample
     * weighting.
     *
     * @return automatically generated
     */
