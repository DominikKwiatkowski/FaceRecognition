...
public class SVM extends StatModel {
     ...
     *     subset is used to test the model, the others form the train set. So, the %SVM algorithm
     *     is
     ...
     * @param balanced If true and the problem is 2-class classification then the method creates
     *     more balanced cross-validation subsets that is proportions between classes in subsets are
     ...
     *     <p>This function only makes use of SVM::getDefaultGrid for parameter optimization and
     *     thus only offers rudimentary parameter options.
     ...
     * @param nuGrid grid for nu
     * @param coeffGrid grid for coeff
     * @param degreeGrid grid for degree balanced cross-validation subsets that is proportions
     *     between classes in subsets are close to such proportion in the whole train dataset.
     *     <p>The method trains the %SVM model automatically by choosing the optimal parameters C,
     *     gamma, p, nu, coef0, degree. Parameters are considered optimal when the cross-validation
     *     estimate of the test set error is minimal.
     *     <p>This function only makes use of SVM::getDefaultGrid for parameter optimization and
     ...
     * @param gammaGrid grid for gamma
     * @param pGrid grid for p
     * @param nuGrid grid for nu balanced cross-validation subsets that is proportions between
     *     classes in subsets are close to such proportion in the whole train dataset.
     *     <p>The method trains the %SVM model automatically by choosing the optimal parameters C,
     *     gamma, p, nu, coef0, degree. Parameters are considered optimal when the cross-validation
     *     estimate of the test set error is minimal.
     ...
     * @param kFold Cross-validation parameter. The training set is divided into kFold subsets. One
     *     subset is used to test the model, the others form the train set. So, the %SVM algorithm
     *     is balanced cross-validation subsets that is proportions between classes in subsets are
     *     close to such proportion in the whole train dataset.
     *     <p>The method trains the %SVM model automatically by choosing the optimal parameters C,
     *     gamma, p, nu, coef0, degree. Parameters are considered optimal when the cross-validation
     *     estimate of the test set error is minimal.
     ...
     *
     * <p>The method returns all the support vectors as a floating-point matrix, where support
     * vectors are stored as matrix rows.
     *
     * @return automatically generated
     */
     ...
     *
     * <p>The method returns all the uncompressed support vectors of a linear %SVM that the
     * compressed support vector, used for prediction, was derived from. They are returned in a
     * floating-point matrix, where the support vectors are stored as matrix rows.
     *
     * @return automatically generated
     */
     ...
     *     2-class classification, then there will be just one decision function and the index
     *     should always be 0. Otherwise, in the case of N-class classification, there will be
     ...
     *     <p>The method returns rho parameter of the decision function, a scalar subtracted from
     *     the weighted sum of kernel responses.
     * @return automatically generated
     */
     ...
     *     <p>The function generates a grid pointer for the specified parameter of the %SVM
