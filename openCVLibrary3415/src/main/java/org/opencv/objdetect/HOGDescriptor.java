...
public class HOGDescriptor {
    ...
    // Size
    // _cellSize, int _nbins, int _derivAperture = 1, double _winSigma = -1, int _histogramNormType
    // =
    // HOGDescriptor::L2Hys, double _L2HysThreshold = 0.2, bool _gammaCorrection = false, int
    // _nlevels
