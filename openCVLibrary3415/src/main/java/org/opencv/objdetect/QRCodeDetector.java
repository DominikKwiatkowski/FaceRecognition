...
public class QRCodeDetector {
    ...
    //
    // C++:  String cv::QRCodeDetector::decodeCurved(Mat img, Mat points, Mat& straight_qrcode =
    // Mat())
    //
    ...
    public String decodeCurved(Mat img, Mat points, Mat straight_qrcode) {
        return decodeCurved_0(
                nativeObj, img.nativeObj, points.nativeObj, straight_qrcode.nativeObj);
    }
    ...
    //
    // C++:  String cv::QRCodeDetector::detectAndDecodeCurved(Mat img, Mat& points = Mat(), Mat&
    // straight_qrcode = Mat())
    //
    ...
    public String detectAndDecodeCurved(Mat img, Mat points, Mat straight_qrcode) {
        return detectAndDecodeCurved_0(
                nativeObj, img.nativeObj, points.nativeObj, straight_qrcode.nativeObj);
    }
     ...
     * @param points Output vector of vector of vertices of the minimum-area quadrangle containing
     *     the codes.
     * @return automatically generated
     */
     ...
     * @param decoded_info UTF8-encoded output vector of string or empty vector of string if the
     *     codes cannot be decoded.
     * @param points vector of Quadrangle vertices found by detect() method (or some other
     *     algorithm).
     * @param straight_qrcode The optional output vector of images containing rectified and
     *     binarized QR codes
     * @return automatically generated
     */
    ...
    //
    // C++:  bool cv::QRCodeDetector::detectAndDecodeMulti(Mat img, vector_String& decoded_info,
    // Mat& points = Mat(), vector_Mat& straight_qrcode = vector_Mat())
    //
    ...
    // C++:  bool cv::QRCodeDetector::detect(Mat img, Mat& points)
    private static native boolean detect_0(
    ...
    private static native String decode_1(
            long nativeObj, long img_nativeObj, long points_nativeObj);

    // C++:  String cv::QRCodeDetector::decodeCurved(Mat img, Mat points, Mat& straight_qrcode =
    // Mat())
    private static native String decodeCurved_0(
            long nativeObj,
            long img_nativeObj,
            long points_nativeObj,
            long straight_qrcode_nativeObj);

    private static native String decodeCurved_1(
            long nativeObj, long img_nativeObj, long points_nativeObj);
    ...
    // C++:  String cv::QRCodeDetector::detectAndDecodeCurved(Mat img, Mat& points = Mat(), Mat&
    // straight_qrcode = Mat())
    private static native String detectAndDecodeCurved_0(
            long nativeObj,
            long img_nativeObj,
            long points_nativeObj,
            long straight_qrcode_nativeObj);

    private static native String detectAndDecodeCurved_1(
            long nativeObj, long img_nativeObj, long points_nativeObj);
