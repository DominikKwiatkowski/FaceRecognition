...
public class BackgroundSubtractorMOG2 extends BackgroundSubtractor {
     ...
     * component, it is considered foreground or added as a new component. 3 sigma =&gt; Tg=3\*3=9
     * is default. A smaller Tg value generates more components. A higher Tg value may result in a
     * small number of components but they can grow too large.
     *
     * @return automatically generated
     */
    ...
    /**
     * Sets the variance threshold for the pixel-model match used for new mixture component
     * generation
     *
     ...
     *
     * <p>This parameter defines the number of samples needed to accept to prove the component
     * exists. CT=0.05 is a default value for all the samples. By setting CT=0 you get an algorithm
     * very similar to the standard Stauffer&amp;Grimson algorithm.
     *
     * @return automatically generated
     */
     ...
     *     value makes the algorithm to use some automatically chosen learning rate. 0 means that
     *     the background model is not updated at all, 1 means that the background model is
